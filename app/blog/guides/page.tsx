    ...
    <div className="min-h-screen relative z-10">
      ...
      <main className="relative max-w-5xl mx-auto px-4 py-12">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-semibold tracking-tight mb-2">SQL import guides</h1>
          <p className="text-muted-foreground">
            Pillar guides to fix timeouts, packet limits, and hosting restrictions.
          </p>
        </div>

        <div className="grid gap-4 sm:grid-cols-2">
          {guides.map((guide) => (
            <Link key={guide.slug} href={`/blog/guides/${guide.slug}`} className="block group">
