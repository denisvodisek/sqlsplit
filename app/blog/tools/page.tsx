    ...
    <div className="min-h-screen relative z-10">
      ...
      <main className="relative max-w-5xl mx-auto px-4 py-12">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-semibold tracking-tight mb-2">SQL import tools</h1>
          <p className="text-muted-foreground">
            How to import large dumps with popular tools and avoid timeouts.
          </p>
        </div>

        <div className="grid gap-4 sm:grid-cols-2">
          {tools.map((tool) => (
            <Link key={tool.slug} href={`/blog/tool/${tool.slug}`} className="block group">
